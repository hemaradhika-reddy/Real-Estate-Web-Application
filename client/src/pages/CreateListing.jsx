...
const CreateListing = () => {
  ...
  return (
    ...
    <h1 className='text-3xl font-semibold text-center my-7 text-sky-700'>Create a listing</h1>
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-5'>
        <div className='flex flex-col gap-2 flex-1'>
            <input 
                ...
                value={formData.name}
                className='border p-3 rounded-lg border-sky-300  focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all duration-300 transform hover:scale-105 focus:scale-105' 
                id='name' 
                maxLength='62' 
                minLength='10'  
                required 
            ...
            <textarea 
                ...
                className='border p-3 rounded-lg border-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-500-200 transition-all duration-300 transform hover:scale-105 focus:scale-105' 
                id="description" 
                required
            ></textarea>
            <input 
                ...
                {formData.offer && (
                    <div className="flex items-center gap-2">
                        <input 
                            ...
                            className='border-sky-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all duration-300 transform hover:scale-105 focus:scale-105' 
                            required
                        />
                        <div className='flex flex-col items-center'>
        ...
        <div className="flex flex-col flex-1 gap-3">
            ...
            {formData.imageUrls.length > 0 && formData.imageUrls.map((image, index) => (
                <div key={image.id} className="flex justify-center p-3 border items-center">
            ...
            <button 
                ...
                className='p-3 bg-sky-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 transform hover:scale-105 transition-all duration-300'
            >
